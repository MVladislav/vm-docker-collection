...
| **monitoring**        |                    |                                                                                          |                                                                                     |
|                       | Monitoring         | beszel                                                                                   | Lightweight server monitoring hub with historical data, docker stats, and alerts.   |
|                       | Monitoring         | checkmk                                                                                  | IT monitoring software for servers, applications, and networks.                     |
|                       | webhook            | gotify                                                                                   | A simple server for sending and receiving messages.                                 |
...
|                       | Tooling            | IT-Tools                                                                                 | Useful tools for developer and people working in IT.                                |
