...
| **helper**              |                                                                        |                     |                                                                                   |         |               |        |
| Container Management    | [dockhand](https://github.com/Finsys/dockhand)                         | v1.0.49             | Docker management you will like.                                                  | 2026-07 | 🟢 up-to-date | yes    |
| Dashboard               | [glance](https://github.com/glanceapp/glance)                          | v0.8.6              | A self-hosted dashboard that puts all your feeds in one place.                    | 2026-06 | 🟢 up-to-date | yes    |
| Proxy                   | [traefik](https://doc.traefik.io)                                      | v3.7.13             | Cloud-native reverse proxy and load balancer for Docker and Kubernetes.           | 2026-06 | 🟢 up-to-date | yes    |
| **monitoring**          |                                                                        |                     |                                                                                   |         |               |        |
...
| Monitoring              | [patchmon](https://github.com/PatchMon/PatchMon)                       | 2.1.3               | Linux Patch Monitoring Automation Platform.                                       | 2026-07 | 🟢 up-to-date | yes    |
| Monitoring              | [speedtest-tracker](https://github.com/alexjustesen/speedtest-tracker) | 1.15.0              | Tool for tracking internet speed test results over time.                          | 2026-06 | 🟢 up-to-date | yes    |
| **other**               |                                                                        |                     |                                                                                   |         |               |        |
| Media Tracker           | [yamtrack](https://github.com/FuzzyGrim/Yamtrack)                      | 0.26.3              | Media tracker.                                                                    | 2026-07 | 🟢 up-to-date | yes    |
| **privacy**             |                                                                        |                     |                                                                                   |         |               |        |
...
| **sec-tool-services**   |                                                                        |                     |                                                                                   |         |               |        |
| Security Tools          | [so-crates](https://github.com/dougburks/so-crates)                    | 4.2.0               | Security Onion deployment and management toolkit for Docker.                      | 2026-08 | 🟢 up-to-date | yes    |
| **siem**                |                                                                        |                     |                                                                                   |         |               |        |
...
| **sys-admin**           |                                                                        |                     |                                                                                   |         |               |        |
| Automation              | [semaphore](https://github.com/semaphoreui/semaphore)                  | v2.19.12            | Open-source CI/CD and Ansible automation platform.                                | 2026-08 | 🟢 up-to-date | yes    |
| **sys-backup**          |                                                                        |                     |                                                                                   |         |               |        |
| Code Hosting            | [forgejo](https://codeberg.org/forgejo/forgejo)                        | 16                  | Self-hosted lightweight software forge.                                           | 2026-07 | 🟢 up-to-date | yes    |
| Email Archiving         | [open-archiver](https://github.com/LogicLabs-OU/OpenArchiver)          | v0.6.0              | Legally compliant email archiving.                                                | 2026-07 | 🟢 up-to-date | yes    |
| **sys-design**          |                                                                        |                     |                                                                                   |         |               |        |
...
| **sys-finance**         |                                                                        |                     |                                                                                   |         |               |        |
| Invoicing               | [InvoiceShelf](https://github.com/InvoiceShelf/docker)                 | 2.4.5               | Open-source invoicing software.                                                   | 2026-04 | 🟡 older      | yes    |
| **sys-infra**           |                                                                        |                     |                                                                                   |         |               |        |
...
| Project Management      | [plane](https://github.com/makeplane/plane)                            | v1.4.2              | Helps you track your issues, epics, and cycles the easiest way on the planet.     | 2026-06 | 🟢 up-to-date | yes    |
| Project Management      | [plane-com](https://github.com/makeplane/plane)                        | v2.6.3              | Commercial version of Plane for project management.                               | 2026-07 | 🟢 up-to-date | yes    |
| **sys-security**        |                                                                        |                     |                                                                                   |         |               |        |
| Identity Management     | [goauthentik](https://github.com/goauthentik/authentik)                | 2026.8.3            | Open-source identity and access management system.                                | 2026-09 | 🟢 up-to-date | yes    |
| Password Manager        | [infisical](https://github.com/Infisical/infisical)                    | v0.165.16           | Open-source secrets, certificates, and privileged access management.              | 2026-08 | 🟢 up-to-date | yes    |
| Identity Management     | [keycloak](https://github.com/keycloak/keycloak)                       | 26.7.4              | Open-source identity and access management.                                       | -       | 🆕 new        | yes    |
| **sys-tools**           |                                                                        |                     |                                                                                   |         |               |        |
| News                    | [freshrss](https://github.com/FreshRSS/FreshRSS)                       | 1.30.0              | Self-hosted RSS feed reader.                                                      | 2026-06 | 🟢 up-to-date | yes    |
| Search Engine           | [searxng](https://github.com/searxng/searxng)                          | 2026.9.23-3cd69d30e | Privacy-focused metasearch engine.                                                | 2026-08 | 🟢 up-to-date | yes    |
| Tooling                 | [ittools](https://github.com/CorentinTh/it-tools)                      | 2026.7.11           | Useful tools for developer and people working in IT.                              | 2026-03 | 🟡 older      | yes    |
| Tooling                 | [omni-tools](https://github.com/iib0011/omni-tools)                    | 0.6.0               | Collection of powerful web-based tools for everyday tasks.                        | 2026-03 | 🟡 older      | yes    |
...
| Tooling                 | [stirling-pdf](https://github.com/Stirling-Tools/Stirling-PDF)         | 2.14.3              | Tool for PDF document manipulation and editing.                                   | 2026-03 | 🟡 older      | yes    |
...
| Configuration           | [README](./__template/README.md)                                                                    | -                  | Base configuration and templates for Docker Swarm with Traefik.                     | -       | -            | -   |
| **ai**                  |                                                                                                     |                    |                                                                                     |         |              |     |
| AI                      | [opencode](https://github.com/anomalyco/opencode)                                                   | 1.18.32            | Open source coding agent.                                                           | 2026-01 | 🟡 older     | ±   |
| **dev**                 |                                                                                                     |                    |                                                                                     |         |              |     |
...
| IPAM                    | [netbox](https://github.com/netbox-community/netbox-docker)                                         | v3.4               | IP address management and data center infrastructure modeling.                      | 2024-03 | 🔴 stale     | yes |
...
| Backup Automation       | [zerobyte](https://github.com/nicotsx/zerobyte)                                                     | v0.21              | Backup automation.                                                                  | 2026-01 | 🟡 older     | yes |
| **sys-design**          |                                                                                                     |                    |                                                                                     |         |              |     |
| Diagramming             | [drawio](https://github.com/jgraph/docker-drawio)                                                   | 31.4.6             | Web-based diagramming tool for creating flowcharts and designs.                     | 2026-04 | 🟡 older     | yes |
...
| Resume                  | [rxresu](https://github.com/AmruthPillai/Reactive-Resume)                                           | v5.0.0             | A one-of-a-kind resume builder that keeps your privacy in mind.                     | 2026-01 | 🟡 older     | yes |
